...
contract NFTfi is NFTfiAdmin, NFTfiSigningUtils, ERC721 {
    ...
    function beginLoan(
        ...
        // contracts.
        require(erc20CurrencyIsWhitelisted[loan.nftCollateralContractAndloanERC20[1]], 'Currency denomination is not whitelisted to be used by this contract');
        require(nftContractIsWhitelisted[loan.nftCollateralContractAndloanERC20[0]], 'NFT collateral contract is not whitelisted to be used by this contract');
